...
var RWC002Corpus = struct {
	...
	SourceReferences []string // named by the user as checked; NOT independently fetched — see baseline doc §1
}{
...
// path to fetch independent data from them (baseline doc §1) — so the
