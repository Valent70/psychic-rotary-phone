"""Render the Final Authority Hardening Round Response report to a
...
SOURCE = ROOT / "docs" / "VERIQO_FINAL_AUTHORITY_HARDENING_RESPONSE.md"
OUTPUT = ROOT / "docs" / "VERIQO_FINAL_AUTHORITY_HARDENING_RESPONSE.pdf"
