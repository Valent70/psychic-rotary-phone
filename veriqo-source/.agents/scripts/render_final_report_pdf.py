"""Render the final report to a dependency-free, text-based PDF."""
...
SOURCE = ROOT / "docs" / "VERIQO_FINAL_GAP_CLOSURE_REPORT.md"
OUTPUT = ROOT / "docs" / "VERIQO_FINAL_GAP_CLOSURE_REPORT.pdf"
...
print(f"wrote={OUTPUT} bytes={len(data)} pages={page_count}")