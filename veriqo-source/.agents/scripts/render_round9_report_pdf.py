"""Render the Round 9 (L99) gap closure report to a dependency-free,
text-based PDF -- same renderer as render_final_report_pdf.py, pointed
at the new source/output paths, so every report in this deliverable
uses one consistent, zero-dependency rendering pipeline."""
...
SOURCE = ROOT / "docs" / "VERIQO_ROUND9_L99_GAP_CLOSURE_REPORT.md"
OUTPUT = ROOT / "docs" / "VERIQO_ROUND9_L99_GAP_CLOSURE_REPORT.pdf"
