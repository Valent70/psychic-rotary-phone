"""Render the Verification & Trust Boundary Response report to a
...
SOURCE = ROOT / "docs" / "VERIQO_VERIFICATION_TRUST_BOUNDARY_RESPONSE.md"
OUTPUT = ROOT / "docs" / "VERIQO_VERIFICATION_TRUST_BOUNDARY_RESPONSE.pdf"
