"""Render the VTECP-001 + CRE closure report to a dependency-free,
text-based PDF -- same renderer as render_final_internal_check_report_pdf.py
...
so every report in this deliverable uses one consistent, zero-dependency
rendering pipeline."""
...
SOURCE = ROOT / "docs" / "VERIQO_VTECP_CRE_CLOSURE_REPORT.md"
OUTPUT = ROOT / "docs" / "VERIQO_VTECP_CRE_CLOSURE_REPORT.pdf"
