"""Render the Authority Round 2: Manifest, Rights & Supersession Closure report to a
...
SOURCE = ROOT / "docs" / "VERIQO_AUTHORITY_ROUND_2_CLOSURE_RESPONSE.md"
OUTPUT = ROOT / "docs" / "VERIQO_AUTHORITY_ROUND_2_CLOSURE_RESPONSE.pdf"
