"""Render the Round 10 (L99) Level 3 assessment report to a
dependency-free, text-based PDF -- same renderer as
render_final_report_pdf.py / render_round9_report_pdf.py, pointed at
the new source/output paths, so every report in this deliverable uses
one consistent, zero-dependency rendering pipeline."""
...
SOURCE = ROOT / "docs" / "VERIQO_ROUND10_L99_LEVEL3_ASSESSMENT_REPORT.md"
OUTPUT = ROOT / "docs" / "VERIQO_ROUND10_L99_LEVEL3_ASSESSMENT_REPORT.pdf"
