...
// new domain logic (baseline doc gap G2 — pkg/moat/domain/maritime models vessel/port ENTITIES and ownership, but has
...
func EvaluateVesselAtPort(v Vessel, p Port) ConstraintResult {
	...
	case p.TideDependent:
		...
		// (docs/RWC_V2_NATIVE_INTEGRATION_BASELINE.md §1).
