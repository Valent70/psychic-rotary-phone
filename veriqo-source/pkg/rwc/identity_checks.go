...
// RWC-002 — see rwc002.go — precisely because this environment has no
// live AIS/registry network access (docs/RWC_V2_NATIVE_INTEGRATION_BASELINE.md §1) and the brief
